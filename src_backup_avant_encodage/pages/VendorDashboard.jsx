...
export default function VendorDashboard() {
  ...
  const handleMediaUpload = async (e) => {
    ...
    try {
      ...
      toast({ 
        title: error.message.includes('Rate limit') ? "?? Limite atteinte" : "Échec du téléchargement",
    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <Tabs defaultValue="dossiers" className="w-full">
        ...
        <TabsList className="w-max min-w-full justify-start bg-stone-100 p-1 gap-0">
          ...
          <TabsTrigger value="settings" className="px-3 sm:px-6 text-xs sm:text-sm whitespace-nowrap">?? Paramètres</TabsTrigger>
        </TabsList>
        </div>
