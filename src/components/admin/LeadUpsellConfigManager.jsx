...
export default function LeadUpsellConfigManager() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          <h2 className="text-2xl font-bold text-stone-900 flex items-center gap-2">
            ...
            Configuration Upsell & Monetisation
          </h2>
          <p className="text-stone-500 mt-1">
            Gerez les prix des abonnements, packs et pass temporaires
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="border-purple-200">
          ...
          <CardContent className="space-y-4 pt-6">
            <div>
              <Label>Prix Premium (FCFA/mois)</Label>
              <Input
                type="number"
              ...
              <p className="text-xs text-stone-500 mt-1">
                Quota leads eleve + Badge Premium
              </p>
            </div>
            <div>
              <Label>Prix Gold (FCFA/mois)</Label>
              <Input
                type="number"
              ...
              />
              <p className="text-xs text-stone-500 mt-1">
                Leads illimites + Priorite maximale + Badge Gold
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-blue-200">
          <CardHeader className="bg-blue-50">
            ...
            <CardDescription>Packs de credits leads</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4 pt-6">
            <div className="grid grid-cols-2 gap-3">
              <div>
                <Label>Pack 10 Leads (FCFA)</Label>
                <Input
                  type="number"
              ...
              <div>
                ...
                <Input
                  disabled
                  value={`${(config.pack_10_leads_price / 10).toFixed(0)} FCFA`}
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <Label>Pack 25 Leads (FCFA)</Label>
                <Input
                  type="number"
              ...
              <div>
                ...
                <Input
                  disabled
                  value={`${(config.pack_25_leads_price / 25).toFixed(0)} FCFA`}
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <Label>Pack 50 Leads (FCFA)</Label>
                <Input
                  type="number"
              ...
              <div>
                ...
                <Input
                  disabled
                  value={`${(config.pack_50_leads_price / 50).toFixed(0)} FCFA`}
                />
              </div>
            </div>
          </CardContent>
        ...
        <Card className="border-orange-200">
          ...
          <CardContent className="space-y-4 pt-6">
            <div>
              <Label>Pass Illimite 24h (FCFA)</Label>
              <Input
                type="number"
              ...
              />
              <p className="text-xs text-stone-500 mt-1">
                Acces illimite pendant 24 heures
              </p>
            </div>
            <div>
              <Label>Test Premium 24h (FCFA)</Label>
              <Input
                type="number"
        ...
        <Card className="border-stone-200">
          <CardHeader className="bg-stone-50">
            ...
            <CardDescription>Parametres d'affichage et seuils</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4 pt-6">
            <div>
            ...
            <div className="space-y-3 pt-2 border-t">
              ...
              <div className="flex items-center justify-between p-3 bg-stone-50 rounded">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">Achat a l'unite</span>
                </div>
                <Button
                  size="sm"
                ...
                >
                  {config.show_single_purchase ? "Visible" : "Cache"}
                </Button>
              </div>
              ...
              <div className="flex items-center justify-between p-3 bg-stone-50 rounded">
                ...
                >
                  {config.show_packs ? "Visible" : "Cache"}
                </Button>
              </div>
              ...
              <div className="flex items-center justify-between p-3 bg-stone-50 rounded">
                ...
                >
                  {config.show_temporary_passes ? "Visible" : "Cache"}
                </Button>
              </div>
            </div>
          </CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Simulation de Rentabilite</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="grid md:grid-cols-3 gap-4">
            <div className="p-4 bg-blue-50 rounded-lg">
              <p className="text-sm text-stone-600 mb-2">Revenus Pack 25 leads</p>
              <p className="text-2xl font-bold text-blue-600">{config.pack_25_leads_price.toLocaleString()} FCFA</p>
              <p className="text-xs text-stone-500 mt-1">Valeur par lead: {(config.pack_25_leads_price / 25).toFixed(0)} FCFA</p>
            </div>
            <div className="p-4 bg-purple-50 rounded-lg">
              <p className="text-sm text-stone-600 mb-2">Revenus Premium (1 mois)</p>
              <p className="text-2xl font-bold text-purple-600">{config.premium_monthly_price.toLocaleString()} FCFA</p>
            ...
            <div className="p-4 bg-amber-50 rounded-lg">
              ...
              <p className="text-2xl font-bold text-amber-600">{config.gold_monthly_price.toLocaleString()} FCFA</p>
